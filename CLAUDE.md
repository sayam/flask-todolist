...
- ผลปัจจุบัน: **ผ่าน 132 · ไม่เกี่ยวข้อง 69 · ยังไม่ผ่าน 52**
...
- **การต่อสายเป็นลำดับด้วยการล็อกแถวเดียวของ `tdl_audit_lock`** (ADR 0035
  ...
  **deadlock** แทน (วัดจริง: writer 8 ตัว ตาย 128 จาก 160 ครั้ง)
  ...
  · **เทสต์ความขนานต้องใช้ ≥8 สาย** สองสายไม่พอจะสร้างวงจรของ deadlock
  และนั่นคือเหตุผลที่ของเดิมเขียวมาตลอดทั้งที่ล็อกพังอยู่
...
reverse proxy, TLS, ≥2 replica, IdP และ directory · CI มี **20 job** ที่ยิง
