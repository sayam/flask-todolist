...
## หลังปิดแผน G — งานที่มาจากรอบ audit (r1–r16)
...
- `pillar:` ครบทุก gate ใน `gates.yaml` (`tests/test_gates.py` บังคับ —
  ...
  — วันนี้ (หลัง r16) เป็น security 67 · devx 18 · manageability 16 · performance 4
  รวม 105 gate · **ตัวเลขชุดนี้ไม่มีเทสต์คุม** จึงต้องกวาดตอนทำ doc sweep)
