...
ทั้งหมดแล้วพิมพ์หน้าเดียว ก่อนหน้านี้คำถามนี้ต้องเปิด **8 ที่** (audit รอบ 13 ข้อ 4)
· พื้นผิวที่ต้องต่อเน็ตไม่อยู่ในนั้นโดยตั้งใจ — มันมีตัวตรวจที่รันทุก push แล้ว (job `posture`)
