...
| [0075](0075-thesis-track-freeze-effort-and-ceilings.md) | สายวิทยานิพนธ์: เก็บเวลาใน `effort-log.csv` · ถอดแกน governance เป็น repo `verifiable-gates` (Apache-2.0 + CLA · กฎ CC BY 4.0) แล้ว freeze ที่ tag `thesis-freeze-1` · เพดานบนของ gate · เอกสารใหม่ต้องมีเครื่องอ่านคู่ · พัก audit จนสอบเสร็จ | accepted |
