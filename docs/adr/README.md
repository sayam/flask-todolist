...
| [0032](0032-serialising-audit-appends.md) | ต่อสาย audit ให้เป็นลำดับด้วยการล็อกแถวท้าย | accepted — **ข้อ 1 ถูกแทนโดย 0035** |
...
| [0070](0070-relicense-to-agpl-and-cc-by-sa.md) | เปลี่ยนสัญญาอนุญาตเป็น AGPL-3.0 (โค้ด) + CC BY-SA 4.0 (เอกสาร) | accepted — แทนที่ 0038 · ข้อ 4 ถูกแทนโดย 0076 |
...
| [0075](0075-thesis-track-freeze-effort-and-ceilings.md) | สายวิทยานิพนธ์: เก็บเวลาใน `effort-log.csv` · ถอดแกน governance เป็น repo `verifiable-gates` (Apache-2.0 + CLA · กฎ CC BY 4.0) แล้ว freeze ที่ tag `evidence-freeze-1` · เพดานบนของ gate · เอกสารใหม่ต้องมีเครื่องอ่านคู่ · พัก audit จนสอบเสร็จ | accepted |
| [0076](0076-cla-for-relicensing.md) | PR ที่แตะแกน governance (path ที่ถอดไป `verifiable-gates` แล้ว — ปิด 2026-08-28) ต้องลงนาม `CLA.md` — ให้สิทธิ์ relicense เป็น Apache-2.0 ไม่โอนลิขสิทธิ์ · โค้ดของแอปไม่มี CLA · DCO ยังอยู่ | accepted — แทนที่ 0070 ข้อ 4 · 0073 ข้อ 1 |
| [0077](0077-consume-verifiable-gates-as-a-submodule.md) | บริโภค `verifiable-gates` เป็น submodule ตรึง SHA · `scripts/` เหลือเป็น adapter · ลบ `overlays/` และเทสต์ที่ตามของไป · ถอด gate ที่คำอ้างไม่เป็นจริงกับ repo นี้อีก | accepted |
| [0078](0078-the-rules-move-to-verifiable-gates.md) | กฎย้ายไป `rules.yaml` ของ verifiable-gates · ที่นี่เหลือการบังคับ · คลังเก็บสองภาษา (อังกฤษเผยแพร่ · ไทยต้นฉบับใน `*_th`) · ด่านเทียบสองทิศไม่ให้สองสำเนาเพี้ยนจากกัน | accepted |
| [0073](0073-dco-sign-off.md) | ทุก commit ต้องมี `Signed-off-by` (DCO 1.1) — ปิดข้อสุดท้ายของ baseline-2 และเกณฑ์ `dco` ของ silver ในคราวเดียว | accepted — ข้อ 1 ("ไม่ใช่ CLA") ถูกแทนโดย 0076 |
