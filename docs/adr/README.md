...
| [0075](0075-thesis-track-freeze-effort-and-ceilings.md) | สายวิทยานิพนธ์: เก็บเวลาใน `effort-log.csv` · freeze artifact ที่ tag `thesis-freeze-1` · เพดานบนของ gate · เอกสารใหม่ต้องมีเครื่องอ่านคู่ · พัก audit จนสอบเสร็จ | accepted |
| [0076](0076-cla-for-relicensing.md) | ผู้ร่วมพัฒนาภายนอกลงนาม `CLA.md` (ให้สิทธิ์ relicense ไม่โอนลิขสิทธิ์) ก่อน merge · DCO ยังอยู่ · เปิดทาง dual-license ไว้ก่อนรับโค้ดคนนอกใบแรก | accepted — แทนที่ 0070 ข้อ 4 · 0073 ข้อ 1 |
