...
| [0076](0076-cla-for-relicensing.md) | PR ที่แตะแกน governance (path ที่จะถอดไป `verifiable-gates`) ต้องลงนาม `CLA.md` — ให้สิทธิ์ relicense เป็น Apache-2.0 ไม่โอนลิขสิทธิ์ · โค้ดของแอปไม่มี CLA · DCO ยังอยู่ | accepted — แทนที่ 0070 ข้อ 4 · 0073 ข้อ 1 |
