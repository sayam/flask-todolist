...
| Branch protection | ✅ 2026-08-13 | บังคับ PR + **ครบทั้ง 23 check** + linear history · ห้าม force push และห้ามลบ branch · **`enforce_admins: false`** เจ้าของยัง push ตรงได้ (โปรเจกต์คนเดียว การบังคับ PR กับตัวเองคือความช้าที่ไม่ซื้ออะไร) · ต้อง approve 0 คน เพราะคนเดียว approve PR ตัวเองไม่ได้ — ตั้ง 1 เมื่อไหร่คือ merge ไม่ได้ตลอดกาล |
