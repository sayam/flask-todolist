...
| CI/CD | 26 job (28 check) ยิงของจริงทุก push — สามยี่ห้อฐานข้อมูล, stack จริง, IdP จริง | `.github/workflows/ci.yml` · required checks |
...
| review โดยคนที่สอง | required checks ทั้งชุดแทน (ผู้ดูแลคนเดียว — GitHub ไม่ให้ approve PR ตัวเอง) | ตั้ง approvals ≥1 กับคนเดียว = merge ไม่ได้ตลอดกาล · เงื่อนไขทบทวน: มีผู้ดูแลคนที่สอง |
