...
call, and 24 CI jobs (26 checks) that run against real databases, a real reverse
...
| | |
|---|---|
| [`docs/adr/`](docs/adr/) | 48 architecture decision records — every choice, the options rejected, and what would reverse it |
...
ไม่ต้องจำว่าต้องเรียก · และ CI 24 job (26 check) ที่ยิงใส่ฐานข้อมูลจริง
...
[`docs/adr/`](docs/adr/) 48 ใบ (ทุกการตัดสินใจ ทางที่ไม่ได้เลือก และเงื่อนไข
