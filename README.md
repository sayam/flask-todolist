...
| | |
|---|---|
| [`docs/adr/`](docs/adr/) | 46 architecture decision records — every choice, the options rejected, and what would reverse it |
...
[`docs/adr/`](docs/adr/) 46 ใบ (ทุกการตัดสินใจ ทางที่ไม่ได้เลือก และเงื่อนไข
