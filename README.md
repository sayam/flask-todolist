...
- จัดหมวดงานเองได้ (เพิ่ม/แก้/ลบ) เช่น งานส่วนตัว, งาน delivery, งานตอบจดหมาย
- ลบหมวดแล้วงานไม่หาย แค่กลับไปเป็น "ไม่มีหมวด"
...
- หน้า Settings รวมโปรไฟล์ (ชื่อ-นามสกุล), ภาษา, ธีม และเขตเวลาไว้ที่เดียว
...
คำสั่ง `create-user` จะถามรหัสผ่าน (ยาวอย่างน้อย 8 ตัว) และสร้างหมวดตั้งต้นให้ 4 หมวด
...
142 tests ครอบคลุมงาน/หมวด, การแยกข้อมูลระหว่าง user, CSRF, rate limit,
การตรวจ `SECRET_KEY`, การเลือกภาษา, ธีม, เขตเวลา, settings และ CLI
