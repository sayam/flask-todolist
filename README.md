...
| [`SKILL.md`](SKILL.md) | 63 framework-agnostic baseline rules, **generated** from the portable gates. Each one carries the trap that produced it. You cannot write a rule into this file by hand — you add a gate and regenerate. App-type agreements (the rules a different app could legitimately choose differently, like soft delete) live in their own generated sheet, [`SKILL-TODOLIST.md`](SKILL-TODOLIST.md) |
...
| | |
|---|---|
| [`docs/adr/`](docs/adr/) | 55 architecture decision records — every choice, the options rejected, and what would reverse it |
...
- [`SKILL.md`](SKILL.md) — กฎ baseline 63 ข้อ **generate จาก gate ที่ portable**
...
[`docs/adr/`](docs/adr/) 55 ใบ (ทุกการตัดสินใจ ทางที่ไม่ได้เลือก และเงื่อนไข
