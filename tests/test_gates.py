...
# คำที่ผูกกับ *สถาปัตยกรรมของ repo นี้* — ต่างจากรายการชื่อ framework ที่ vg บังคับ
...
def test_baseline_rules_do_not_speak_our_architecture(gates):
    ...
    **ตรวจทั้งชื่อกฎและบทเรียน** เพราะทั้งสองอย่างถูกเผยแพร่ผ่านคลังกฎของ vg
    ไปด้วยกัน · บรรทัดที่ชี้ไฟล์/job ของ repo นี้ (`enforced_by`) ไม่ถูกตรวจ
    เพราะนั่นคือส่วนอ้างอิง ไม่ใช่ส่วนกฎ — หลักเดียวกับที่ตัวอ่านคลังของ vg
