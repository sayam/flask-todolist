...
**กฎ:** พื้นของ ratchet ต้องไม่ลอยต่ำกว่าของจริงเกินระยะที่ประกาศ

**เกิดจาก:** audit รอบ 12 — `pyproject.toml` เขียนกำกับว่า "ขยับขึ้นได้อย่างเดียว" ทั้งสองที่ แต่ไม่มีอะไรทำให้มันขยับ · หกวันหลังตั้งเลข coverage จริงไต่ไป 97.11% ขณะที่พื้น ยังเป็น 96 (ตั้งตอนวัดได้ 96.31%) — ที่ว่าง 1.11 จุดคือโค้ดที่มีเทสต์คุมราว 54 บรรทัดซึ่งหายไปได้โดยไม่มีอะไรแดง · กลไกที่ถูกมีอยู่แล้วในโปรเจกต์นี้ (`LINE_SLACK` ของ ADR 0065) แค่ยังไม่เคยถูกเอาไปใช้กับ ratchet ตัวอื่น
